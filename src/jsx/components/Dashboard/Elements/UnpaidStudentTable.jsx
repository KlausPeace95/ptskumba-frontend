...
// Default avatar images for students
...
const defaultAvatars = [trans1, trans2, trans3, trans4, trans5];
...
export const UnpaidStudentTable = () => {
    ...
    useEffect(() => {
        const fetchStudents = async () => {
            try {
                setLoading(true);
                setError(null);
                const response = await StudentsService.getStudentsForFeesTable(currentPage, recordsPage);
    ...
    const npage = Math.ceil(totalCount / recordsPage);
    ...
    // Get avatar for student (cycle through default avatars)
    const getStudentAvatar = (studentId) => {
        return defaultAvatars[studentId % defaultAvatars.length];
    };
    ...
    const formatStudentData = (student) => {
        return {
            id: student.id,
            image: getStudentAvatar(student.id),
            name: student.full_name || `${student.first_name} ${student.last_name}`,
            studid: `ID ${student.admission_number}`,
            class: student.class_level_display || 'N/A',
            fee: '0.00', // This would come from fees API in a real implementation
            rank: 'N/A' // This would come from grades API in a real implementation
        };
    };
            ...
            <div id="teacher-table_wrapper" className="dataTables_wrapper no-footer">
                <table id="example-1" className="display dataTable no-footer w-100" >
                    ...
                    <tbody>
                        {students.map((student, ind) => {
                            const item = formatStudentData(student);
                            return (
                                <tr key={student.id}>
                                    <td>
                                    ...
                                    <td><span className="text-primary font-w600">{item.studid}</span></td>
                                    <td>
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="ms-2">
                                                ...
                                                <h6 className="text-primary mb-0 font-w600">{item.class}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span className="doller font-w600"> $ {item.fee}</span></td>
                                    <td>{item.rank}</td>
                                    <td>
                                            ...
                                            <li>
                                                ...
                                                <Dropdown className="custom-dropdown ">
                                                    ...
                                                    <Dropdown.Menu className="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <Dropdown.Item>
                                                            <Link to={`/students/${student.id}/edit`} className="text-decoration-none">
                ...
                <div className="d-sm-flex text-center justify-content-between align-items-center">
                    <div className='dataTables_info'>
                        Showing {((currentPage - 1) * recordsPage) + 1} to{" "}
                        {Math.min(currentPage * recordsPage, totalCount)}
