            ...
            <div className="navbar-nav header-right">
              ...
              <Dropdown as="li" className="nav-item dropdown header-profile">
                <Dropdown.Toggle variant="" as="a" className="nav-link i-false c-pointer" role="button" data-toggle="dropdown">
                  ...
                  <div className="header-info ms-3">
                    <span className="font-w600">
                      {user?.first_name || 'Finance'} <b>{user?.last_name || 'User'}</b>
                    </span>
                ...
                <Dropdown.Menu align="end" className="mt-3 dropdown-menu dropdown-menu-end">
                  <Link to="/finance-dashboard/profile" className="dropdown-item ai-icon">
                  ...
                  <Link to="/finance-dashboard/settings" className="dropdown-item ai-icon">
